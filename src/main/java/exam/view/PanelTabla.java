...
public class PanelTabla extends JPanel {
	...
	private PanelContratos panelEstudiante;
	 ...
	 * junto al JSplitPane.
	 */
	public PanelTabla(PanelContratos panelEstudiante) {
		...
		jbtnFirst.setIcon(new ImageIcon(PanelTabla.class.getResource("/exam/res/gotostart.png")));
		...
		jbtnPrevious.setIcon(new ImageIcon(PanelTabla.class.getResource("/exam/res/previous.png")));
		...
		jbtnNext.setIcon(new ImageIcon(PanelTabla.class.getResource("/exam/res/next.png")));
		...
		jbtnLast.setIcon(new ImageIcon(PanelTabla.class.getResource("/exam/res/gotoend.png")));
	...
	public void showSelectedRow() {
		try {
			...
			Contrato est = (Contrato) ControladorContrato
	 ...
	 * @param e
	 */
	public void selectRowById(Contrato e) {
